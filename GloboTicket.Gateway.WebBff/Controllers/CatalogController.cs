...
namespace GloboTicket.Gateway.WebBff.Controllers
{
    ...
    public class CatalogController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetCatalogBrowse(Guid categoryId, Guid basketId)
        {
            try
            {
                var getBasket = basketService.GetBasket(basketId);
            ...
            {
                // Log the exception somewhere you can see it
