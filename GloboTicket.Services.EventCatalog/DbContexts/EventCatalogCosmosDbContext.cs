...
namespace GloboTicket.Services.EventCatalog.DbContexts
{
    public class EventCatalogCosmosDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            // New: IntegrationEventLogs config
            modelBuilder.Entity<IntegrationEventLog>()
                .ToContainer("IntegrationEventLogs")       // Separate container
                .HasPartitionKey(e => e.PartitionKey)
                .HasNoDiscriminator();                     // Not using inheritance
            ...
            modelBuilder.Entity<Event>()
                ...
                .HasData(
                    ...
                    new
                    {
                        ...
                        Price = 65,
                        EventId = Guid.Parse("{EE272F8B-6096-4CB6-8625-BB4BB2D89E8B}"),
                        EventCategoryId = concertGuid.ToString()
                    },
                    new
                    {
                    ...
                    new
                    {
                        ...
                        Price = 400,
                        EventId = Guid.Parse("{1BABD057-E980-4CB3-9CD2-7FDD9E525668}"),
                        EventCategoryId = conferenceGuid.ToString()
                    },
                    ...
                    new
                    {
                        ...
                        Price = 135,
                        EventId = Guid.Parse("{ADC42C09-08C1-4D2C-9F96-2D15BB1AF299}"),
                        EventCategoryId = musicalGuid.ToString()
                    },
                    new
                    {
