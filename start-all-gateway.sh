...
gnome-terminal -- bash -c "cd \"$BASE_DIR/GloboTicket.Gateway.WebBff\" && dotnet run; exec bash"
gnome-terminal -- bash -c "cd \"$BASE_DIR/GloboTicket.Web.Bff\" && dotnet run; exec bash"